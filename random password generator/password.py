...
sc1=StringVar('')
t1=Label(screen,text='Random Password Generator',font=('Arial',25),fg='blue',background ="Light grey")
t1.place(x=60,y=0)
t2=Label(screen,text='Password:',font=('Arial',14),background ="Light grey")
t2.place(x=145,y=90)

il=Entry(screen,font=('Arial',14),textvariable=sc1)
il.place(x=270,y=90)
t3=Label(screen,text='Length: ',font=('Arial',14),background ="Light grey")
t3.place(x=145,y=120)

t4=Label(screen,text='Strength:',font=('Arial',14),background ="Light grey")
...
b=Button(screen,text='Generate',font=('Arial',14),fg='blue',background ="white",command=gen)
b.place(x=230,y=195)
